...
const ReferralDashboard: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-3 sm:p-6 space-y-4 sm:space-y-6">
      <div className="text-center">
        <h2 className="text-xl sm:text-2xl font-bold text-farm-green mb-2">Your Referral Dashboard</h2>
        <p className="text-sm sm:text-base text-farm-earth">
          {isMobile ? 'Earn by referring friends!' : 'Earn rewards by referring friends to Local Pickup Box!'}
        </p>
      </div>
      ...
      <div className={`grid grid-cols-1 ${isMobile ? 'gap-3' : 'md:grid-cols-3 gap-4'}`}>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold text-green-600">{totalReferrals}</div>
      ...
      {!referralCode ? (
        <Card>
          <CardContent className="pt-6">
            <div className="text-center space-y-4">
              <p className="text-sm sm:text-base text-farm-earth">Generate your referral code to start earning!</p>
              <Button 
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl">Share Your Referral Link</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className={`flex items-center ${isMobile ? 'flex-col' : 'flex-row'} space-y-2 sm:space-y-0 sm:space-x-2`}>
              <input
                type="text"
                value={userReferralLink}
                readOnly
                className="flex-1 w-full p-2 border border-gray-300 rounded-md bg-gray-50 text-xs sm:text-sm"
              />
              <Button 
            ...
            <div className="text-xs sm:text-sm text-farm-earth bg-green-50 p-3 rounded-md">
